...
INSERT INTO orders (id, status, order_date, delivery_deadline, customer_id) VALUES
    (1001, 'NEW', '2023-04-01', '2030-06-02', 1001),
    (1002, 'IN_PROGRESS', '2023-04-10', '2030-06-01', 1002),
    (1003, 'READY', '2023-04-02', '2023-04-03', 1003),
    (1004, 'NEW', '2023-04-03', '2023-05-18', 1004),
    (1005, 'IN_PROGRESS', '2023-04-05', '2023-04-15', 1005),
    (1006, 'READY', '2023-04-01', '2023-05-17', 1006);
...
INSERT INTO materials (id, quality, size, hit_number,unit_price, unit_weight, unit_length, original_weight, original_length, remaining_weight, remaining_length, warehouse_id) VALUES
    ...
    (1005, '21CrMoV57', 21.84, 267237, 1525, 9.860, 6.084, 11000, 1100, 11000, 1100, 2),
    (1006, '42CrMo4', 21.96, 402141, 4995, 2.037, 3.928, 1600, 800, 1600, 800, 2);

INSERT INTO products (id, status, name, quality, size, length, quantity) VALUES
    (1001, 'new', 'szegcsavar1', '25CrMo4', 12, 80, 23),
    (2, 'new', 'szegcsavar2', '21CrMoV57', 16, 60, 10),
